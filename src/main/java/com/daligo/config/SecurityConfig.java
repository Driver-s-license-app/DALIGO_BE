...
import com.daligo.security.jwt.JwtAccessDeniedHandler;
import com.daligo.security.oauth.CustomOAuth2UserService;
import com.daligo.security.oauth.OAuth2AuthenticationFailureHandler;
import com.daligo.security.oauth.OAuth2AuthenticationSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .exceptionHandling().authenticationEntryPoint(restAuthenticationEntryPoint) // 인증,인가가 되지 않은 요청 시 발생
                .accessDeniedHandler(jwtAccessDeniedHandler)
                .and()
                .authorizeRequests()
                .antMatchers("/auth/**", "/oauth2/**", "/login/**").permitAll()
                .antMatchers( "/h2-console/**","/swagger-ui/**", "/swagger-resources/**", "/v3/api-docs", "/swagger-ui.html").permitAll() // Security 허용 Url
